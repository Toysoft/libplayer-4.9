...
int enable_freescale_MBX()
{
    ...
    switch (disp_mode) {
    case DISP_MODE_480I:
        property_get("ubootenv.var.480i_x", vaxis_x_str, "0");
        property_get("ubootenv.var.480i_y", vaxis_y_str, "0");
        property_get("ubootenv.var.480i_w", vaxis_width_str, "720");
        property_get("ubootenv.var.480i_h", vaxis_height_str, "480");
        break;
    case DISP_MODE_480P:
        property_get("ubootenv.var.480p_x", vaxis_x_str, "0");
        property_get("ubootenv.var.480p_y", vaxis_y_str, "0");
        property_get("ubootenv.var.480p_w", vaxis_width_str, "720");
        property_get("ubootenv.var.480p_h", vaxis_height_str, "480");
        break;
    case DISP_MODE_576I:
        property_get("ubootenv.var.576i_x", vaxis_x_str, "0");
        property_get("ubootenv.var.576i_y", vaxis_y_str, "0");
        property_get("ubootenv.var.576i_w", vaxis_width_str, "720");
        property_get("ubootenv.var.576i_h", vaxis_height_str, "576");
        break;
    case DISP_MODE_576P:
        property_get("ubootenv.var.576p_x", vaxis_x_str, "0");
        property_get("ubootenv.var.576p_y", vaxis_y_str, "0");
        property_get("ubootenv.var.576p_w", vaxis_width_str, "720");
        property_get("ubootenv.var.576p_h", vaxis_height_str, "576");
        break;
    case DISP_MODE_720P:
        property_get("ubootenv.var.720p_x", vaxis_x_str, "0");
        property_get("ubootenv.var.720p_y", vaxis_y_str, "0");
    ...
    case DISP_MODE_1080I:
        property_get("ubootenv.var.1080i_x", vaxis_x_str, "0");
        property_get("ubootenv.var.1080i_y", vaxis_y_str, "0");
    ...
    case DISP_MODE_1080P:
        property_get("ubootenv.var.1080p_x", vaxis_x_str, "0");
        property_get("ubootenv.var.1080p_y", vaxis_y_str, "0");
