    ...
    namespace network
    {
        class AbstractChunk : public virtual IDownloadableChunk
        {
            ...
            private:
                ...
                // use curl_mod, noblock
                int64_t download_speed;
                CFContext * curl_handle;
                bool close_flag;
	            ...
	            static uint32_t BANDWIDTH_NOTIFY_THRESHOLD;
                static uint64_t MAX_BLOCKSIZE;
                static uint32_t MAX_SLEEPTIME;
                static uint64_t MAX_BLOCKSIZE2;
