...
#define LIBDASH_FRAMEWORK_PORTABLE_MULTITHREADING_H_
    ...
    #define PortableSleepMs(mSeconds)    Sleep(mSeconds)
    ...
    #define PortableSleepMs(mSeconds)                     usleep(mSeconds * 1000)
    ...
    #define SleepConditionVariableTime(cond_p, mutex_p, timeout) pthread_cond_timedwait(cond_p, mutex_p, timeout)
