        ...
        namespace mpd
        {
            class SingleMediaSegmentStream: public AbstractRepresentationStream
            {
                public:
                    ...
                    virtual uint64_t                    GetSegmentStartTimeByOffset(uint32_t offset) { return 0; }
                    virtual int32_t                     GetSegmentOffsetByTime(uint64_t timeToFind) { return -2; }
                    virtual uint32_t                   GetStartNumber() {return 0;}
                    virtual bool                         HasTimeLineOrNot() { return false;}
